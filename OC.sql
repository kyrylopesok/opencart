...
--
-- Хост: localhost
-- Время создания: Ноя 29 2016 г., 14:47
...
(1, '4poiF8BuxkU66cFJwOzCtlRiZ0x7JVoDATmGRn1FOMCLoIUbWJdFvvoKlbHuwwyx', '', '', '', 1, '2016-11-27 16:26:40', '2016-11-27 16:26:40');
...
(1, 'Pound Sterling', 'GBP', '£', '', '2', 0.80549997, 1, '2016-11-28 16:44:53'),
(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2016-11-29 11:40:30'),
(3, 'Euro', 'EUR', '', '€', '2', 0.94480002, 1, '2016-11-28 16:44:53');
...
(1, 0, 'order_guest', 'a:2:{s:4:"name";s:10:"zzzz zzzzz";s:8:"order_id";i:1;}', '127.0.0.1', '2016-11-28 18:20:20'),
(2, 0, 'order_guest', 'a:2:{s:4:"name";s:25:"lkjij iiiiiiiiiiiiiiiiiim";s:8:"order_id";i:2;}', '127.0.0.1', '2016-11-28 19:05:12'),
(3, 0, 'order_guest', 'a:2:{s:4:"name";s:17:"oioiuuuu uupuuuuu";s:8:"order_id";i:3;}', '127.0.0.1', '2016-11-28 19:15:34');
...
--
-- Структура таблицы `oc_customer_home`
--

CREATE TABLE `oc_customer_home` (
  `id` int(8) NOT NULL,
  `date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `ip` varchar(20) COLLATE utf8_bin NOT NULL,
  `addres` varchar(60) COLLATE utf8_bin NOT NULL
...
(477, 'module', 'filter'),
(476, 'module', 'carousel'),
(475, 'module', 'newsletter'),
(478, 'module', 'slideshow'),
(464, 'module', 'tg_kspro_settings'),
(465, 'module', 'tg_kspro_revolution_slider'),
(466, 'module', 'tg_kspro_megamenu'),
(467, 'module', 'tg_kspro_megamenu_vertical'),
(468, 'module', 'tg_kspro_filter_product');
...
(2, 'Türkçe', 'tr', 'tr_TR.UTF-8,tr_TR,tr-tr,turkish', 'tr.png', 'turkish', 1, 1);
...
(118, 1, 'html.50', 'content_bottom', 3),
(119, 1, 'category', 'header_left', 0),
(120, 1, 'html.51', 'content_bottom', 4),
(117, 1, 'html.48', 'header_right', 1),
(99, 3, 'category', 'column_left', 1),
(100, 2, 'category', 'column_left', 0),
(116, 1, 'html.47', 'header_right', 0);
...
(3, 0, 'INV-2013-00', 0, 'Your Store', 'http://localhost:8002/', 0, 1, 'oioiuuuu', 'uupuuuuu', 'Kir-12@i.ua', '99999999999999999999', 'fax', 'a:0:{}', 'oioiuuuu', 'uupuuuuu', 'company', 'mmmmmmmmmmmmm', 'mmm', 'mmmmmm', '9999', 'Ukraine', 220, 'Kyiv', 3490, '', 'a:0:{}', 'Cash On Delivery', 'cod', 'oioiuuuu', 'uupuuuuu', 'company', 'mmmmmmmmmmmmm', 'mmm', 'mmmmmm', '9999', 'Ukraine', 220, 'Kyiv', 3490, '', 'a:0:{}', 'Flat Shipping Rate', 'flat.flat', '', 85.0000, 1, 0, 0.0000, 0, '', 1, 2, 'USD', 1.00000000, '127.0.0.1', '', 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.99 Safari/537.36 OPR/41.0.2353.69', 'ru-RU,ru;q=0.8,en-US;q=0.6,en;q=0.4', '2016-11-28 19:15:31', '2016-11-28 19:15:34');
...
(738, 0, 'config', 'config_encryption', 'ecba734952c7da16a98a893a2b8fd035', 0),
...
(715, 0, 'config', 'config_ftp_hostname', 'localhost:8002', 0),
...
(706, 0, 'config', 'config_image_related_height', '170', 0),
(705, 0, 'config', 'config_image_related_width', '170', 0),
(704, 0, 'config', 'config_image_additional_height', '74', 0),
(703, 0, 'config', 'config_image_additional_width', '74', 0),
(702, 0, 'config', 'config_image_product_height', '170', 0),
(701, 0, 'config', 'config_image_product_width', '170', 0),
(700, 0, 'config', 'config_image_popup_height', '500', 0),
(699, 0, 'config', 'config_image_popup_width', '500', 0),
(698, 0, 'config', 'config_image_thumb_height', '400', 0),
(697, 0, 'config', 'config_image_thumb_width', '400', 0),
(695, 0, 'config', 'config_image_category_width', '170', 0),
(696, 0, 'config', 'config_image_category_height', '170', 0),
...
(650, 0, 'config', 'config_admin_language', 'en', 0),
(648, 0, 'config', 'config_zone_id', '3563', 0),
(649, 0, 'config', 'config_language', 'en', 0),
(647, 0, 'config', 'config_country_id', '222', 0),
(645, 0, 'config', 'config_template', 'kingstorepro', 0),
...
(636, 0, 'config', 'config_email', 'Kir-12@i.ua', 0),
(635, 0, 'config', 'config_geocode', '', 0),
(634, 0, 'config', 'config_address', 'Address 1', 0),
(633, 0, 'config', 'config_owner', 'Your Name', 0),
(632, 0, 'config', 'config_name', 'Your Store', 0),
(766, 0, 'information', 'information_status', '1', 0),
(765, 0, 'kingstorepro_skin', 'kingstorepro_skin', 'kingstorelitedefault', 0),
(767, 0, 'category', 'category_status', '1', 0),
(768, 0, 'tg_kspro_revolution_slider', 'tg_kspro_revolution_slider_module', 'a:1:{i:0;a:5:{s:9:"slider_id";s:1:"1";s:9:"layout_id";s:1:"1";s:8:"position";s:10:"header_top";s:10:"sort_order";s:0:"";s:6:"status";s:1:"1";}}', 1);
...
--
-- Структура таблицы `oc_tg_kspro_revolution_slider`
--
...
--
-- Дамп данных таблицы `oc_tg_kspro_revolution_slider`
--
...
(1, 1, 'admin', '0402cc56eb659205710300021d771db40346a99b', '94c9fda00', 'John', 'Doe', 'Kir-12@i.ua', '', '', '127.0.0.1', 1, '2016-11-27 16:26:40');
...
--
-- Индексы таблицы `oc_customer_home`
--
ALTER TABLE `oc_customer_home`
  ADD PRIMARY KEY (`id`);
...
--
-- Индексы таблицы `oc_tg_kspro_revolution_slider`
--
...
--
-- AUTO_INCREMENT для таблицы `oc_customer_home`
--
ALTER TABLE `oc_customer_home`
...
--
ALTER TABLE `oc_order_total`
  MODIFY `order_total_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
...
--
ALTER TABLE `oc_setting`
  MODIFY `setting_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=769;
--
...
--
-- AUTO_INCREMENT для таблицы `oc_tg_kspro_revolution_slider`
--
ALTER TABLE `oc_tg_kspro_revolution_slider`
